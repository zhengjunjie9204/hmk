...
public class RevenueSellActivity extends BaseActivity implements View.OnClickListener {
    ...
    private int a;
    private List<Project> mList = new ArrayList<>(), mProject = new ArrayList<>();
    private ProjectListAdapter mAdapter, projectAdapter;
    ...
    private void initView() {
        ...
        projectAdapter = new ProjectListAdapter(this, mProject, deleteItemCountTwo, textChangeTwo);
    ...
    private ProjectListAdapter.IDeleteItemCount deleteItemCountTwo = new ProjectListAdapter.IDeleteItemCount() {
        @Override
        public void onItemDelete(int position) {
    ...
    private ProjectListAdapter.ITextChange textChangeTwo = new ProjectListAdapter.ITextChange() {
        @Override
        public void onTextChange(int position, String s) {
            if (!TextUtils.isEmpty(s)) {
                Project project = mProject.get(position);
