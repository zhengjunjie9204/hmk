 ...
 *
 * @author zajo
 * @created 2015年10月15日 14:48
 */
public class CustomDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener, NumberPicker.OnValueChangeListener {
    ...
    public CustomDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
        ...
        setTitle("日期选择");
        setButton(BUTTON_POSITIVE, "完 成", this);
